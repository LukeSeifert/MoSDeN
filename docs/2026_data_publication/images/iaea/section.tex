...
This table shows that bromine alone has five isotopes that affect the \gls{DNP} group parameters, with $^{87}$Br being the dominant isotope due to its long-half life that makes it the primary \gls{DNP} for the group one parameters.
...
\caption{Chart of nuclide plots showing the \glspl{PCC} and uncertainty-weighted \glspl{PCC}.}
