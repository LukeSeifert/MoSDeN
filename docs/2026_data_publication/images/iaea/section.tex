...
This is why the Keepin 6-group Fit data is unity at all times, as it is always self-equivalent.
...
Figure \ref{fig:sens-iaea-jendl} shows two examples for how the \glspl{PCC} are calculated using the 5000 samples.
